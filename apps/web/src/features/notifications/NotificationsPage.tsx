  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Alert matches and your daily job brief.</p>
      </div>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 mt-0.5 whitespace-pre-line">{n.body}</p>
